        ...
        <div class="w-64 bg-white shadow-lg">
            <div class="flex items-center justify-between h-16 px-6 border-b border-gray-200">
                <div class="flex items-center">
                    ...
                    <span class="ml-3 text-lg font-semibold text-gray-900">Kepala Panel</span>
                </div>
            </div>
            ...
            <nav class="mt-6 px-3">
                <div class="space-y-1">
                    ...
                    <a href="{{ route('kepala.monitoring-penilaian') }}" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 {{ request()->routeIs('kepala.monitoring-penilaian') ? 'bg-purple-50 text-purple-700' : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900' }}">
                        <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('kepala.komentar-umum') }}" 
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 {{ request()->routeIs('kepala.komentar-umum') ? 'bg-purple-50 text-purple-700' : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900' }}">
                        <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
