    ...
    <div class="max-w-md w-full space-y-8">
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-3xl font-bold text-gray-900">Login Staff</h2>
                <p class="mt-2 text-sm text-gray-600">Masuk ke panel Staff</p>
            </div>
            ...
            @if($errors->any())
                <div class="bg-red-50 border-l-4 border-red-400 p-4 mb-6">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-red-700">Email atau NIP salah.</p>
                        </div>
                    </div>
                </div>
            @endif
            ...
            <form method="POST" action="{{ route('staff.login') }}" class="space-y-6">
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-gray-700">NIP</label>
